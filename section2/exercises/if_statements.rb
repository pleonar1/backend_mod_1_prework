...
######I changed it to sunny and it output sunscreen.  good code
  weather = 'sunny'
...
####Both conditions can be achieved when run with different values for the varialbe num_quarters
...
#This code will satisfy all scenarios. 
